...
Sys.setenv(SPLIV_PACKAGE_PATH = normalizePath(pkg_path, mustWork = TRUE), SPLIV_SIM_PROFILE = "pilot", SPLIV_SIM_CORES = "1")
setwd(sim_root)
status <- system2(Sys.which("Rscript"), c("--vanilla", shQuote(file.path(sim_root, "04_run_all_pilot.R"))))
